 ...
 *
 * $Id: Strings.java,v 1.2 2005/06/19 14:55:02 vlad_r Exp $
 */
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            for (int i = 0; i < length; ++ i)
            {
                ...
                if (s.startsWith ("@"))
                {
                	// do not tokenize the string further to allow for pathname
                	// strings with whitespace in them (note that this is not
                	// a perfect solution to embedding at-files within a spec
                	// string because of the ambiguity between @ and whitespace
                	// delimiting priority)
                	
                	final String [] fileList = Files.readFileList (new File (s.substring (1)));
                ...
                else
                {
	                ...
	                while (tokenizer.hasMoreTokens ())
	                {
	                    ...
	                    if (ss.startsWith ("@"))
	                    {
	                    	// ss is an at-file pathname (not containing any
