 ...
 *
 * $Id: ReportProperties.java,v 1.2 2005/04/26 01:55:01 vlad_r Exp $
 */
...
//    }
    ...
    public static ParsedProperties parseProperties (final IProperties properties, final String type)
    {
        ...
        {
            final String outDirName = getReportProperty (properties, type, IReportProperties.OUT_DIR, true, false);
            final String outFileName = getReportProperty (properties, type, IReportProperties.OUT_FILE, false, false);
        ...
        {
            final String unitsType = getReportProperty (properties, type, IReportProperties.UNITS_TYPE, true, true, IReportProperties.DEFAULT_UNITS_TYPE);
        ...
        {
            final String hideClasses = getReportProperty (properties, type, IReportProperties.HIDE_CLASSES, true, true, IReportProperties.DEFAULT_HIDE_CLASSES);
        ...
        {
            final String depth = getReportProperty (properties, type, IReportProperties.DEPTH, false, true, IReportProperties.DEFAULT_DEPTH);
        ...
        {
            final String columnList = getReportProperty (properties, type, IReportProperties.COLUMNS, false, true, IReportProperties.DEFAULT_COLUMNS);
        ...
        {
            final String sortList = getReportProperty (properties, type, IReportProperties.SORT, false, true, IReportProperties.DEFAULT_SORT);
        ...
        {
            final String metricList = getReportProperty (properties, type, IReportProperties.METRICS, true, true, IReportProperties.DEFAULT_METRICS);
...
//    } // end of nested class
    ...
    private static String getReportProperty (final IProperties properties, final String type, final String key, final boolean allowBlank, final boolean trim)
    {
        return getReportProperty (properties, type, key, allowBlank, trim, null);
    }

    private static String getReportProperty (final IProperties properties, final String type, final String key, final boolean allowBlank, final boolean trim, final String dflt)
    {
        ...
        String result = properties.getProperty (IReportProperties.PREFIX.concat (type).concat (".").concat (key), dflt);
